...
public class QuoteController {
    ...
    /**
     *  You may ignore this, this was our previous way of 'logging in'.
     * @param user username used to login
     * @param auth base64 encoded username and password
     * @return text corresponding to the success of logging in
     */
